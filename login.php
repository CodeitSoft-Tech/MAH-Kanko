        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              ...
              <div class="btn-wrapper text-center">
				...
				<img src="img/k-logo.gif" style="width:110px;height:90px;"/>
				<h1 class="text-lead">KANKO</h1>
                <p class="text-lead text-lead ">Smart Bussiness Connections...</p>
				<h3>Login</h3>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <?php
                ...
                <div class="text-center">
                    <button type="submit" name="submit" class="btn btn-primary my-4" style="width:100%;background:#582ee6 !important;border-color:#582ee6;">Login</button>
                </div>
              </form>
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="shop.php" class="text-light"><small>Shop</small></a>
            </div>
          </div>
        </div>
      </div>
